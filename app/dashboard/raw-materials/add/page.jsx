        ...
        <form className="max-w-full sm:max-w-xl mt-26 mx-auto shadow-md sm:rounded-lg p-5">
          ...
          <div className="grid md:grid-cols-2 md:gap-6">  
              <div className="relative z-0 w-full mb-5 group">
                  ...
                  <label htmlFor="floating_first_name" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Raw Material Name</label>
              </div>
              <div className="relative z-0 w-full mb-5 group">
          ...
          <div className="relative z-0 w-full mb-5 group">
              ...
              <label htmlFor="floating_email" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Warehouse</label>
          </div>
          ...
          <div className="relative z-0 w-full mb-5 group">
            ...
            <div className="grid md:grid-cols-1 max-w-xs mb-5 ">
                <label htmlFor="quantity-input" className="block mb-2 peer-focus:font-medium text-sm font-medium text-gray-500 dark:text-gray-400">Quantity</label>

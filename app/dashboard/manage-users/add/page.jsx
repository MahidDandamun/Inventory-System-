    ...
    <div className="p-4 sm:ml-64">     
      <div className="p-4 rounded-lg dark:border-gray-700 mt-14 overflow-y-auto">     
        <form className="max-w-full sm:max-w-xl mt-26 mx-auto shadow-md sm:rounded-lg p-5">
          ...
          <div className="grid md:grid-cols-2 md:gap-6">
            <div className="relative z-0 max-w-full mb-5 group">
           ...
           <div className="grid md:grid-cols-1 max-w-xs ">
                <label htmlFor="quantity-input" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Permission Level</label>
                ...
                <p id="helper-text-explanation" className="mt-2 text-sm text-gray-500 dark:text-gray-400">(1=Admin, 2=Secretary, 3=Employee.)</p>

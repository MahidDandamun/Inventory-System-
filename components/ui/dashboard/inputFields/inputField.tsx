...
export function FileInputField({name, label}:{name:string, label:string}) {
  return (
    <>
      <div className="flex flex-col items-center w-full mb-8">
        <p className="text-start peer-focus:font-medium text-sm font-medium text-gray-500 dark:text-gray-400">{`Insert the ${label} image`}</p>
          <label htmlFor={name} className="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50   dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
